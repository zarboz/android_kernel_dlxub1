...
static struct l2_level l2_freq_tbl_8064[] = {
	...
	[16] = { { 1188000, HFPLL, 1, 0, 0x2C }, 1150000, 1150000, 8 },
};
...
static struct acpu_level acpu_freq_tbl_8064_slow[] = {
	...
	{ 1, {  1566000, HFPLL, 1, 0, 0x38 }, L2(16), 1250000 },
        { 1, {  1674000, HFPLL, 1, 0, 0x3C }, L2(16), 1275000 },
...
static struct acpu_level acpu_freq_tbl_8064_nom[] = {
	...
	{ 1, {  1566000, HFPLL, 1, 0, 0x38 }, L2(16), 1200000 },
        { 1, {  1674000, HFPLL, 1, 0, 0x3C }, L2(16), 1225000 },
        { 1, {  1728000, HFPLL, 1, 0, 0x3E }, L2(16), 1250000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8064_fast[] = {
	...
	{ 1, {  1566000, HFPLL, 1, 0, 0x38 }, L2(16), 1150000 },
        { 1, {  1674000, HFPLL, 1, 0, 0x3C }, L2(16), 1175000 },
...
static struct cpufreq_frequency_table freq_table[NR_CPUS][33];
